...
from istream_player.modules.renderer import OpenGLRenderer, HeadlessRenderer
from istream_player.modules.enhancer import IMDNEnhancer
...
class PlayerComposer:
    ...
    def create_arg_parser(self):
        ...
        parser.add_argument('-r', "--run_dir",  help="Run directory, will be automatically OVERWRITTEN", default="istream_run_dir")
    ...
    def register_core_modules(self):
        ...
        self.register_module(
            "nes",
            [BONESController, DynamicGreedyController, BOLAGreedyController, BufferGreedyController, ThroughputGreedyController, NASController],
            single_initializer,
        ...
        self.register_module("enhancer", [IMDNEnhancer], single_initializer, "Enhancer", False, "imdn")
        ...
        self.register_module("renderer", [OpenGLRenderer, HeadlessRenderer], single_initializer, "Renderer", False, "headless")
