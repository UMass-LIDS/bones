...
parser.add_argument("--data_name", type=str, default="bbb", help="dataset name (e.g., news)")
...
parser.add_argument("--use_cuda", action="store_true", default=True, help="use GPU(s) for training")
parser.add_argument("--load_on_memory", action="store_true", default=True, help="load dataset on memory")
