                ...
                for iteration, batch in enumerate(valid_dataloader, 1):
                    ...
                    for node in self.model.getOutputNodes():
                        ...
                        if node == self.model.getOutputNodes()[-1]:
                            self.save_img('{}/{}_{}_output.png'.format(self.opt.result_dir, lr, iteration), output_np)
                            self.save_img('{}/{}_{}_baseline.png'.format(self.opt.result_dir, lr, iteration), upscaled_np)
                            self.save_img('{}/{}_{}_target.png'.format(self.opt.result_dir, lr, iteration), target_np)
