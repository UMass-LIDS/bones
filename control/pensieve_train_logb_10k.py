...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = '../rl/pensieve/results_logb_10k/'
LOG_FILE = '../rl/pensieve/results_logb_10k/log'
...
class PensieveTrain(Simulator):
    def __init__(self, args):
        ...
        self.util_down_avg = np.log(self.bitrate / self.bitrate[0])  # utility of downloading each segment
