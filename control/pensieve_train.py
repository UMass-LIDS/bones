...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = '../rl/pensieve/results'
LOG_FILE = '../rl/pensieve/results/log'
...
class PensieveTrain(Simulator):
    def __init__(self, args):
        ...
        self.util_down_seg = np.mean(self.vmaf_down_seg, axis=0)
    ...
    def act(self, idx_action):
        ...
        util = self.util_down_seg[self.action_down]
        rebuffer = self._act()
        reward = {
